...
with expected(table_name, column_name) as (
  values
    ...
    ('user_account_state', 'ai_consent_status'),
    ('user_account_state', 'ai_consent_version'),
    ('user_account_state', 'ai_consent_granted_at'),
    ('user_account_state', 'ai_consent_updated_at'),
    ('user_account_state', 'ai_consent_withdrawn_at'),
