/**
 * Express API Handler - Annotation API
 ...
 */
function extractComment(rawText, promptLastSentence = '无前缀。') {
 ...
 */
function ensureEmoji(text, tone) {
...
- ABSOLUTELY DO NOT output any  tags or reasoning process! Give the final output immediately!`;
...
function determineTone(content, eventType, currentHour) {
  // 深夜时间（0-5点）
