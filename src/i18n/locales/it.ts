...
const it: TranslationKeys = {
    ...
    chat_placeholder_mood: 'Registra il tuo umore (es. entusiasta)… Tocca ❤️ per passare ad attività',
    ...
    report_observer_waiting: 'L\'osservatore del Prisma del Tempo è in attesa di record…',
    report_generate_diary: 'Visualizza Osservazione di Oggi',
    report_generate_confirm: 'Puoi generare un\'osservazione solo una volta al giorno. Generare ora?',
    ...
    report_weekly_coming_soon: 'Il rapporto settimanale è in viaggio interstellare — in arrivo presto…',
    report_monthly_coming_soon: 'Il rapporto mensile si sta calibrando nella dimensione temporale — restate sintonizzati…',
    report_custom_coming_soon: 'Il rapporto personalizzato sta assemblando i suoi componenti — in lancio presto…',
    ...
    auth_error_invalid_credentials: 'Email o password errata',
    ...
    annotation_hover_pause: 'In pausa — in attesa',
